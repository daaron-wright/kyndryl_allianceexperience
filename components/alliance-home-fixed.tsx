...
export default function AllianceHomeFixed({
  ...
  return (
    ...
    >
      ...
      <img
        className="py-[2px-] py-[-4] py-0 my-3"
        src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-1rKU81hE6yuw32aG8alpPHHHM4uEpV.png"
      ...
      >
        <img
          src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/image-a8zbv24kb0Fyg30VxS8Fh04RWfcnUu.png"
          alt="Kyndryl"
          style={{
            width: "100%",
            height: "100%",
