...
export default function PricingModelModal({ isOpen, onClose, story }: PricingModelModalProps) {
  ...
  const currentContent = currentCaseStudy.solution[currentSolutionIndex]
  ...
  const handleNextSolution = () => {
    if (currentSolutionIndex < currentCaseStudy.solution.length - 1) {
      setCurrentSolutionIndex(currentSolutionIndex + 1)
    }
  }
