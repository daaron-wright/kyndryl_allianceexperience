...
interface DemoFocusModalProps {
  isOpen: boolean
  onClose: () => void
}

export default function DemoFocusModal({ isOpen, onClose }: DemoFocusModalProps) {
      ...
      >
        <div className="p-8 relative" style={{ fontFamily: "TWK Everett, sans-serif" }}>
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-gray-700 leading-relaxed">
                  A Kyndryl Consult concierge is on the way to assist you with personalized AI solution recommendations
                  and answer any questions about our use cases. In the meantime, explore our interactive demonstrations
                  to see AI in action.
                </p>
              </div>
            </div>
          ...
          <div className="flex justify-between items-end">
            <div>
              <img
                src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/design-mode-images/image%281%29%281%29%281%29%281%29%281%29%281%29%281%29%281%29-BvBsEJoz9jYnuaBrinWBGSt5GaVsZd.png"
                alt="15+"
            ...
            <div>
              <img
                src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/design-mode-images/image%281%29%281%29%281%29%281%29%281%29%281%29%281%29%281%29-4CryRxQapg6KEeeyIk7zvYWwOHqsfr.png"
                alt="8"
                className="mb-2 h-12 w-auto"
              />
              <div className="text-gray-700">
