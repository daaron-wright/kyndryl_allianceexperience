...
import GoogleCloudVideoModal from "./google-cloud-video-modal"

interface GoogleCloudTileProps {
  onClick?: () => void
}
...
export default function GoogleCloudTile({ onClick }: GoogleCloudTileProps) {
  ...
  return (
    <>
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 w-full h-1/2 flex flex-col">
          ...
          >
            ...
            >
              Kyndryl's infrastructure expertise combines with Google Cloud's AI and data platform to deliver
      ...
      {isVideoModalOpen && <GoogleCloudVideoModal onClose={() => setIsVideoModalOpen(false)} />}
    </>
  )
}
