...
export default function GoogleCloudScreenSaver({ isOpen, onClose, onProceed }: GoogleCloudScreenSaverProps) {
  ...
  return (
    ...
    >
      ...
      >
        <img
          src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/design-mode-images/Kyndryl-GoogleCloud-alliance-logo-lock-up%281%29%281%29%281%29%281%29%281%29-QlIojJ70mcHFB5g5mhablOgDpgT4Zd.png"
