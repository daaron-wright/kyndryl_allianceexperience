...
export default function BankingFinancialMarkets() {
  ...
  const FeaturedTile = ({ onClick }: { onClick: () => void }) => (
    ...
    >
      <img
        src="/modern-banking-building-with-glass-facade-and-fina.png"
      ...
      <div style={{ padding: "clamp(20px, 3vw, 40px)" }}>
        ...
        >
          Digital transformation in financial services; secure and scalable
        </h2>
        <p
          style={{
        ...
        >
          Modernizing banking infrastructure with cloud-native solutions.
        </p>
  ...
  return (
    <div className="responsive-container">
      ...
      >
        ...
        >
          {/* Left - Banking and Financial Markets Title */}
          <h1
            style={{
