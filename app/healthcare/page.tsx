    ...
    <div className="min-h-screen bg-white relative">
      ...
      <header
        style={{
          ...
          padding: "clamp(20px, 3vh, 40px) clamp(30px, 4vw, 90px)",
      ...
      >
        ...
        >
          ...
          <nav className="flex items-center" style={{ gap: "clamp(16px, 2vw, 40px)" }}>
            <a
              href="/alliances"
              className="text-sm sm:text-base lg:text-lg font-medium text-[#3D3C3C] no-underline py-2 hover:text-black transition-colors"
            >
              Alliances
            </a>
            <a
            ...
            <a
              href="#"
              className="text-sm sm:text-base lg:text-lg font-medium text-[#9E9287] no-underline py-2 cursor-default"
            >
              Capabilities
            </a>
            <a
            ...
            <div
              className="relative border border-[#E5E5E5] rounded"
      ...
      <main
        style={{
          ...
          height: "calc(100% - clamp(120px, 15vh, 200px))",
          display: "grid",
      ...
      >
        ...
        >
          ...
          <div style={{ padding: "clamp(20px, 4vw, 40px)" }}>
            ...
            >
              Patient-centered care; HIPAA compliant solutions
            </h2>
            <p
              style={{
            ...
            >
              Secure healthcare data management and interoperability.
            </p>
        ...
        <div
          ...
          onClick={() => setIsCustomerStoriesModalOpen(true)}
          onMouseEnter={(e) => {
            e.currentTarget.style.transform = "translateY(-2px)"
          }}
          onMouseLeave={(e) => {
        ...
        >
          <img
            src="https://hebbkx1anhila5yf.public.blob.vercel-storage.com/design-mode-images/image%281%29%281%29%281%29%281%29%281%29%281%29%281%29%281%29-avcwYHzidFBrn0N81iEzD13fz7GaPo.png"
            alt="Demos"
