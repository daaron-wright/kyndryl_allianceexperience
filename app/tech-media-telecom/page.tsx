...
export default function TechMediaTelecom() {
      ...
      >
        ...
        >
          ...
          <div style={{ padding: "40px" }}>
            ...
            >
              5G networks and edge computing; ultra-low latency
            </h2>
            <p
              style={{
                fontSize: "18px",
            ...
            >
              Next-generation connectivity and distributed computing platforms.
            </p>
